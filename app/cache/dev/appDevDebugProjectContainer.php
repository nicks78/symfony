...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d0e23d75f1a96ff82296cea19aa50871fd093e9826b3721615e5e723782aa9e4');
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/public-api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json'), 'fallback_format' => 'json', 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'AppFrenchBundle:pagination:pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    /**
     * Gets the public 'lexik_jwt_authentication.jwt_encoder' shared service.
     *
     * @return \Lexik\Bundle\JWTAuthenticationBundle\Encoder\JWTEncoder
     */
    ...
    /**
     * Gets the public 'lexik_jwt_authentication.openssl_key_loader' shared service.
     *
     * @return \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader
     */
    protected function getLexikJwtAuthentication_OpensslKeyLoaderService()
    {
        return $this->services['lexik_jwt_authentication.openssl_key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader(($this->targetDirs[2].'/var/jwt/private.pem'), ($this->targetDirs[2].'/var/jwt/public.pem'), '&D(/2SReg9.g49)&');
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api/' => array('allow_origin' => true, 'allow_headers' => array(0 => 'authorization'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600), '^/' => array('origin_regex' => true, 'allow_origin' => array(0 => '^http://localhost:[0-9]+'), 'allow_headers' => array(0 => 'authorization'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600, 'hosts' => array(0 => '^api\\.'))), array('allow_origin' => true, 'allow_credentials' => false, 'allow_headers' => true, 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false, 'forced_allow_origin_value' => NULL));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59b75c0707e562.88641467')), true);
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'LexikJWTAuthenticationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Lexik/Bundle/JWTAuthenticationBundle'),
            ...
            'jwt_key_pass_phrase' => '&D(/2SReg9.g49)&',
            'jwt_token_ttl' => 3600,
            'locale' => 'en',
            ...
            'lexik_jwt_authentication.pass_phrase' => '&D(/2SReg9.g49)&',
            ...
            'knp_paginator.template.pagination' => 'AppFrenchBundle:pagination:pagination.html.twig',
